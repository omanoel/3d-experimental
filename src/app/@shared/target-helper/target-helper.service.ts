...
export class TargetHelperService {
  ...
  constructor(
    ...
    this._model = {
      axesHelper: new AxesHelper(TargetHelperService.SCALE),
      distanceCameraTarget: 1,
      targetOnClick: null,
      cameraOnClick: null,
      stepper: TargetHelperService.STEP,
    };
  }

  public initialize(): AxesHelper {
    return new AxesHelper(TargetHelperService.SCALE);
  }

  public setPosition(axesHelper: AxesHelper, myPoint: Vector3): void {
    axesHelper.translateX(myPoint.x);
    axesHelper.translateY(myPoint.y);
    axesHelper.translateZ(myPoint.z);
  }
